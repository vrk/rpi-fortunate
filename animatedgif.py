        ...
        while self._running:
            ...
            if action:
                ...
                if action == "click":
                    ...
                    target_frame = int(float(action) * max_index)
                # elif float(action) < 0:
                #    target_frame = max_index + int(float(action) * max_index)
                # else:
                #    target_frame = int(float(action) * max_index)
                last_action = action
                if self._loop == 1:
            ...
            if target_frame != current_frame:
                ...
                print("current frame", current_frame, target_frame)
